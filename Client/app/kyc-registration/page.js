    ...
    if (validateStep(3)) {
      try {
        ...
        if (response.data && response.data.status === 'success') {
          alert(response.data.message || 'Registration successful! Please check your email for login credentials.');
          // Redirect to login page
          window.location.href = '/login';
        } else {
          alert('Registration completed but received unexpected response. Please try logging in.');
          window.location.href = '/login';
        }
      } catch (error) {
          ...
          <form onSubmit={handleSubmit}>
            ...
            {step === 1 && (
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-[#0E1F1B] text-sm mb-1">Password</label>
                  <input
                    type="password"
                    name="password"
                ...
                <div className="flex justify-end mt-6">
                  <button
                    ...
                    disabled={!formData.firstName || !formData.lastName || !formData.email || !formData.password || !formData.phone || !formData.gender || !formData.dob || !formData.address}
                  >
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between mt-6">
                  ...
                  <button
                    type="submit"
                    className="bg-[#43B852] hover:bg-[#0E1F1B] text-white py-2 px-6 rounded-xl flex items-center disabled:opacity-50"
                    disabled={!formData.bankName || !formData.accountHolder || !formData.accountNumber || !formData.ifscCode || !formData.agreedToTerms}
                  >
                    Register Now
                  </button>
                </div>
